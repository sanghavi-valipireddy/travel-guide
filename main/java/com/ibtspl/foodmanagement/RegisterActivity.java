...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Buttons
        Button fab = (Button) findViewById(R.id.edit_register);
        if (fab != null)
...
//                // [END_EXCLUDE]
    ...
    private void createAccount(String mEmailField, String mPasswordField ) {
        Log.d(TAG, "createAccount:" + mEmailField);
        if (!validateForm()) {
            return;
        }
